...
<body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <a href="#" class="logo">
                ...
                <span class="logo-mini"><b></b>Blogs</span>
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-footer">
                                    <form method="POST" action="{{route('logout')}}">
                                        @csrf
                                        <button type="submit" class="btn btn-default btn-flat btn-block">Cerrar
                                            Sesión</button>
                                    </form>
                                </li>
                            </ul>
        ...
        <div class="content-wrapper my-body">
    ...
    @include('partials.scriptslayout')
