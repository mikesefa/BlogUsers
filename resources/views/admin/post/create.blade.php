...
@section('header')
<h1>Creando mi nuevo Post !<small>Publicar </small></h1>
<ol class="breadcrumb">
            ...
            <div class="box box-primary">
                <div class="box-body">
                    ...
                    <div class="form-group {{$errors->has('body') ? 'has-error' : ''}}">
                        ...
                        <textarea rows=10 type="text" name="body" id="editor" value="{{old('body')}}" placeholder="
                ...
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input name="published_at" type="date" value="{{$fechaHoy}}" min="2022-01-01"
                    ...
                    <div class="form-group {{$errors->has('excerp') ? 'has-error' : ''}}">
                        ...
                        <textarea type="text" value="{{old('excerp')}}" name="excerp"
                            placeholder="Ingresa aqui el extracto de la publicación"
                            class="form-control">{{old('excerp')}}</textarea>
